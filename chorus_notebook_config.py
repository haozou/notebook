...
chorus_address = os.getenv("CHORUS_ADDRESS", "http://127.0.0.1:8080")
...
c.NotebookApp.allow_origin = chorus_address
...
notebook.nbextensions.install_nbextension('./chorus_notebook.js', user=True, overwrite=True)

from notebook.services.config import ConfigManager
js_cm = ConfigManager()
js_cm.update('notebook', {"load_extensions": {'chorus_notebook': True}})
